...
<Language>
  ...
  <LocaleResource Name="Admin.Configuration.Settings.Order.RoundingType">
    <Value>Rounding type.</Value>
  </LocaleResource>
  <LocaleResource Name="Admin.Configuration.Settings.Order.RoundingType.Help">
    <Value>The order total''s rounding type.</Value>
  </LocaleResource>
  <LocaleResource Name="Enums.Nop.Services.Catalog.RoundingType.Rounding001">
    <Value>Default rounding</Value>
  </LocaleResource>
  <LocaleResource Name="Enums.Nop.Services.Catalog.RoundingType.Rounding005Up">
    <Value>Rounding up with 0.05 intervals (0.06 round to 0.10)</Value>
  </LocaleResource>
  <LocaleResource Name="Enums.Nop.Services.Catalog.RoundingType.Rounding005Down">
    <Value>Rounding down with 0.05 intervals (0.06 round to 0.05)</Value>
  </LocaleResource>
  <LocaleResource Name="Enums.Nop.Services.Catalog.RoundingType.Rounding01Up">
    <Value>Rounding up with 0.10 intervals (1.05 round to 1.10)</Value>
  </LocaleResource>
  <LocaleResource Name="Enums.Nop.Services.Catalog.RoundingType.Rounding01Down">
    <Value>Rounding down with 0.10 intervals (1.05 round to 1.00)</Value>
  </LocaleResource>
  <LocaleResource Name="Enums.Nop.Services.Catalog.RoundingType.Rounding05">
    <Value>Rounding with 0.50 intervals</Value>
  </LocaleResource>
  <LocaleResource Name="Enums.Nop.Services.Catalog.RoundingType.Rounding1">
    <Value>Rounding with 1.00 intervals (1.01-1.49 round to 1.00, 1.50-1.99 round to 2.00)</Value>
  </LocaleResource>
  <LocaleResource Name="Enums.Nop.Services.Catalog.RoundingType.Rounding1Up">
...
--new column
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id=object_id('[Currency]') and NAME='RoundingType')
BEGIN
	ALTER TABLE [Currency]
	ADD [RoundingType] INT NULL
END
GO

UPDATE [Currency]
SET [RoundingType] = 0
WHERE [RoundingType] IS NULL
GO

ALTER TABLE [Currency] ALTER COLUMN [RoundingType] INT NOT NULL
GO
